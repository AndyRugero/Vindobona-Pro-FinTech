...
Das Projekt wird in sechs einfachen Phasen entwickelt:
\begin{itemize}
    \item \textbf{\color{accentblue}Phase 1: Planung \& Design} \\
      Schreiben des Lastenhefts. Planen der Datenbanktabellen und Erstellen der ersten Skizzen für das UI-Design.
    \item \textbf{\color{accentblue}Phase 2: Login \& Wallets} \\
      Programmieren der Registrierung, des sicheren Logins und der Geldbörsen (Wallets) für die Währungen.
    \item \textbf{\color{accentblue}Phase 3: Geldautomaten-Karte \& Chatbot} \\
      Einbauen der Leaflet-Karte für Wien und Verbinden des KI-Chatbots für Finanzfragen.
    \item \textbf{\color{accentblue}Phase 4: Docker \& DevOps-Vorbereitung} \\
      Verpacken der App in Docker-Container, damit sie auf jedem Computer gleich läuft.
    \item \textbf{\color{accentblue}Phase 5: Kubernetes \& Cloud-Start} \\
      Schreiben der Kubernetes-Konfigurationen und Starten der App in der Microsoft Azure Cloud.
    \item \textbf{\color{accentblue}Phase 6: Testen \& Abgabe} \\
      Ausführen der automatischen Unit-Tests und Durchführung manueller End-to-End-Tests aller Funktionen. Behebung verbleibender Fehler und finale Projektübergabe.
\end{itemize}
